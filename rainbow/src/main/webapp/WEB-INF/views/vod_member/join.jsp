...
<br/>
   ...
   <div class="col-xs-3 col-xs-offset-4 setwidth">
			...
			<form>
                ...
                <div >
                  ...
                  <div >
                   ...
                   <div >
                    <input type="text" maxlength="10" name="gender" pattern="^[-A-Za-z0-9_]+[-A-Za-z0-9_.]*[@]{1}[-A-Za-z0-9_]+[-A-Za-z0-9_.]*[.]{1}[A-Za-z]{2,5}$" class="form-control" placeholder="Gender" required autofocus />
                </div><br/>
                 <div>
                    <input type=text name="year" class="form-control col-xs-5" style="width:33%"   maxlength="4" pattern="^(1|2)(0|9)[0-9]{2}$" placeholder="Year" required  />
                 </div>  
                 <div>
                	 <input type=text name="month" class="form-control col-xs-5" style="width:32%"   maxlength="2" pattern="^[0-9]{2}$" placeholder="Month" required  />
                	 </div>
             	 <div>
                 	 <input type=text name="day" class="form-control col-xs-5" style="width:33%"  maxlength="2" pattern="^[0-9]{2}$" placeholder="Day" required  />
                 	 </div><br/><br/><br/>
               </form>
...
$(function() {	
	$('#joinBtn').click(function(e) {
		...
		var year =$('input:text[name=year]').val();
		var month =$('input:text[name=month]').val();
		var day =$('input:text[name=day]').val();
	 	alert('아이디 : '+id+', 비번 : '+password+', 이름 : '+name+', 이메일 : '+email+', 주소 :' +addr+', 년도 : '+year+", 성별 :"+gender+', 월 : '+month+', 일 : '+day);
	$('form').attr('method','post').attr('action','${context}/member/vod_join').submit();
	});
