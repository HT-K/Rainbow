	...
	<script type="text/javascript">
		$(function() {		
			var login_header =
				...
				+ 	'</li>'
				+   '<li><span class="sub-nav-toggle plus"></span>'
				+		'<a href="${context}/admin/content">movie</a>'
				+ 	'</li>'
				+	'<li>'
				+		'<span class="sub-nav-toggle plus"></span>' 
				+		'<a href="${context}/member/logout">LOGOUT</a>'
	...
	$(function(){
		...
		$('#addMovie').click(function(e){
		  ...
		  var addMovieForm = '<article class="container" style="margin-top: 30px">'
			...
			+'</div>'
			+'<form class="form-horizontal"  id="input" style="margin-top: 30px" enctype="multipart/form-data" action="'+context+'/admin/input" method="post">'
...
+'</article>';    
			...
			$('#inputBtn').click(function(e) {
				...
				alert('영화등록 버튼클릭');
				var $input = $('#input');
				var postData = new FormData($('#input')[0]);
