...
<body>
	...
	<div data-role="header" data-position="fixed" data-theme="a">
		<h1 style="font-size: 16px; font-weight: 15px;">
			Rainbow Box <span><button id="search"
					class="jqm-search-link ui-btn ui-btn-icon-notext ui-corner-all ui-icon-search ui-nodisc-icon ui-alt-icon ui-btn-right">search</button></span>
		</h1>
