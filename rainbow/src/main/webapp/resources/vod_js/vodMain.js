...
var vodMain = {   
      vodDetailForm : function(context,vodName,cash) {  
         ...
         $.ajax(context+'/vod/vodDetail/'+vodName,{
            ...
            var detailForm = '<div class="row">\
                  <img class="col-xs-12" style="padding-left: 39%; padding-right: 30%; " src="'+context+'/resources/vod_image/advertising/logo.png">\
                  </div>\
               <hr />\
               <div class="row" >\
   ...
   vodMainForm : function(context) {
      ...
      var mainForm = '<div class="row"><br/>\
            <img class="col-xs-12" style="padding-left: 15%; padding-right: 15%; " src="'+context+'/resources/vod_image/advertising/logo.png">\
            </div>\
            <hr />\
             <div class="col-xs-12">\
               <h2>최신 영화</h2>\
   ...
   vodLoginForm : function(context) {
      ...
      var loginFrom = '<div class="container">\
         ...
         <div class="account-box">\
              ...
              <hr />\
              <div class="logo" >\
         <img class="col-xs-12" src="'+context+'/resources/vod_image/advertising/logo.png">\
            </div>\
         <br />\
         <br />\
         <br />\
   ...
   vodAtLeastForm : function(context) {
      ...
      var atLeastForm = '<div class="row">\
         <img class="col-xs-12" style="padding-left: 30%; padding-right: 30%; " src="'+context+'/resources/vod_image/advertising/logo.png">\
         </div>\
         <hr />\
          <div class="col-xs-12">\
            <h2>최신 영화</h2>\
