			...
			movieTitle : movieSeq
				...
				var movieUpdateForm = 
					'<article class="container" style="margin-top: 30px">'
		              ...
		              +'<div class="col-sm-6">'
		              +'<img src="'+context+'/resources/rainbow/images/main/'+data.movie.image+'" id="uploadedImg" alt="" style="width:200px;height:230px"/>'
		              +'<div class="col-sm-2">'
		              +'<input type="file" id="image" onchange="admin.readURL(this);" name="image" />'
		              +'</div>' 
		              +'</div>'
		              +'<div class="form-group">'
		              +'<div class="col-sm-12 text-center">'
